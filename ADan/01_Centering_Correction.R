...
save(silent, singles, singles_stops, file="nscore_df_ADan.RData")

library("writexl")
write_xlsx(singles_stops, "ADan_singles.xlsx")
write_xlsx(silent, "ADan_synonymous.xlsx")

write.csv(singles_stops, "ADan_singles.csv", row.names=FALSE)
write.csv(silent, "ADan_synonymous.csv", row.names=FALSE)
