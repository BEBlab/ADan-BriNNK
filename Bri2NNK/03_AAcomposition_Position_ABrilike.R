...
dir.create("03_AAcomposition_Position_Bri2nterm")
path="03_AAcomposition_Position_Bri2nterm"
...
# Work with sequences with an extension of 12 residues
NNK_all_df<-NNK_all_df[NNK_all_df$aa_len == 12,]

# Those sequences that have full Bri2 at nterm constitute the ABri-like subgroup
NNK_all_df<-NNK_all_df[NNK_all_df$Bri2_nterm == T,]
...
aa_frequencies_pos_all<-rbind(pos_2, pos_3, pos_4, pos_5, pos_6,
...
freq_heatmap_all<-ggplot(co_all, aes(factor(Var2, labels=(24:34)), factor(Var1, levels=rev(vectorAA))))+
...
#
p_scatter_all<-ggplot(co_all, aes(x=factor(Var2, labels=24:34), y=value, group=1))+
  geom_point()+
  geom_line()+
  ylim(c(-0.15, 0.15))+
...
aa_frequencies_pos_nucleators_<-rbind(pos_2, pos_3, pos_4, pos_5, pos_6,
                                      pos_7, pos_8, pos_9, pos_10, pos_11, pos_12)
...
freq_heatmap_nucleators<-ggplot(co_nucleators, aes(factor(Var2, labels=(24:34)), factor(Var1, levels=rev(vectorAA))))+
  geom_tile(aes(fill=value), color="white", size=1)+
...
#
p_scatter_nucleators<-ggplot(co_nucleators, aes(x=factor(Var2, labels=24:34), y=value, group=1))+
...
aa_frequencies_pos_nonnucleators_<-rbind(pos_2, pos_3, pos_4, pos_5, pos_6,
                                         pos_7, pos_8, pos_9, pos_10, pos_11, pos_12)
...
freq_heatmap_nonnucleators<-ggplot(co_nonnucleators, aes(factor(Var2, labels=(24:34)), factor(Var1, levels=rev(vectorAA))))+
  geom_tile(aes(fill=value), color="white", size=1)+
...
#
p_scatter_nonnucleators<-ggplot(co_nonnucleators, aes(x=factor(Var2, labels=24:34), y=value, group=1))+
...
diff_heatmap_nucleators_nonnucleators<-ggplot(co_nucleators_nonnucleators, aes(factor(Var2, labels=(24:34)), factor(Var1, levels=rev(vectorAA))))+
...
p_violin_p<-ggplot(co_nucleators_nonnucleators, aes(x=factor(Var2, labels=(24:34)), y=diff))+
...
p_scatter_nucleators_nonnucleators<-ggplot(co_nucleators_nonnucleators, aes(x=factor(Var2, labels=24:34), y=freq ,group=group, color=group))+
  geom_point(size=2)+
...
p_scatter_nucleators_nonnucleators_types<-ggplot(co_nucleators_nonnucleators_sum, aes(x=factor(Var2, labels=24:34), y=sum_freq ,group=group, color=group))+
  geom_point(size=2)+
  geom_line(size=1)+
  geom_text(aes(label=significance), size=5, color="black", vjust=0.65, angle=90, y=0.075)+
  scale_color_manual(values=c("darkred", "darkblue"), label=c("non-nucleator", "nucleator"))+
  ylim(c(-0.1, 0.1))+
