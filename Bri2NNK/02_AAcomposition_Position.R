...
p_scatter_nucleators_nonnucleators_types<-ggplot(co_nucleators_nonnucleators_sum, aes(x=factor(Var2, labels=23:34), y=sum_freq ,group=group, color=group))+
  geom_point(size=2)+
  geom_line(size=1)+
...
#save(nucleators_nucleators,  nonnucleators_nucleators, file = "NNK_all_types_df.RData")
#save(co_nucleators,  co_nonnucleators, co_all, file = "NNK_all_freq_df.RData")
