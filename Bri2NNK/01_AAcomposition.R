...
bars_plot<-ggplot(NNK_all_df_grouped_category, aes(x=factor(aa_len, levels=(1:11), labels=(23:33)),
                                                   y=percent,
                                                   fill=factor(category_fdr, levels=c("nucleators", "Top10 nucleators"))))+
  geom_bar(position="dodge", stat="identity")+
  scale_fill_manual(values=c("#7979BE", "darkblue"))+
